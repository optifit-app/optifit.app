...
const ChangelogEntries = ({ title, description, entries }: Changelog1Props) => {
  return (
    <section className="pb-32">
      ...
      <div className="mt-16 max-w-4xl space-y-16 md:mt-24 md:space-y-24">
        {entries?.length ? (
          <>
          ...
          <>
            {Array.from({ length: 3 }).map((_, key) => (
              ...
              >
                ...
                <div className="flex flex-col">
                  <Skeleton className="h-10 w-100 max-w-screen" />
                  <Skeleton className="h-80 w-100 max-w-screen mt-5" />
                  <Skeleton className="h-50 w-100 max-w-screen mt-5" />
                </div>
              </div>
            ))}
          </>
