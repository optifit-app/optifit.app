      ...
      <div className="container mx-auto lg:max-w-[60%] max-w-[90%]">
        <div className="md:col-span-7 md:col-start-5 lg:col-start-6">
          <article className="prose dark:prose-invert prose-sm">
            ...
            <h2 className="mt-5 text-xl font-medium">Utilisation du service</h2>
            ...
            <p className="mt-1">
              ...
              <span className="font-medium">un tournoi gratuit</span>. Au-delà,
              l’accès aux fonctionnalités se fait via une tarification claire,
              sans engagement caché. Nous nous réservons le droit de modifier le
              modèle de tarification avec un préavis raisonnable.
            </p>
            ...
            <p className="mt-1">
              ...
              par e-mail ou via la plateforme. L'utilisation continue du service
